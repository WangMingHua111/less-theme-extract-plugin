...
const MODULE_TYPE = 'css/less-theme-extract';
...
class LessThemeExtractPlugin {
    ...
    apply(compiler) {
        ...
        compiler.themes = compiler.themes || {}
        compiler.themes[theme] = this.lessOptions
        compiler.hooks.thisCompilation.tap(pluginName, compilation => {
            ...
            compilation.mainTemplate.hooks.renderManifest.tap(pluginName, (result, {
                ...
                const renderedModules = Array.from(chunk.modulesIterable).filter(module => module.type === MODULE_TYPE).filter(module => !module.theme || module.theme === theme);
